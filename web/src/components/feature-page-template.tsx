...
const ACCENT: Record<FeatureAccent, { iconBg: string; iconText: string; badge: string; badgeText: string; btnBg: string; btnHover: string; btnShadow: string; gradFrom: string; gradTo: string; stepBg: string; checkText: string }> = {
  ...
  violet: { iconBg: "bg-[#DBEAFE]", iconText: "text-[#1D4ED8]", badge: "bg-[#DBEAFE]", badgeText: "text-[#1D4ED8]", btnBg: "bg-[#2563EB]", btnHover: "hover:bg-[#1D4ED8]", btnShadow: "shadow-violet-500/25", gradFrom: "from-[#2563EB]", gradTo: "to-[#2563EB]", stepBg: "bg-[#2563EB]", checkText: "text-[#2563EB]" },
  ...
  pink: { iconBg: "bg-[#FDF2F8]", iconText: "text-[#9D174D]", badge: "bg-[#FDF2F8]", badgeText: "text-[#9D174D]", btnBg: "bg-[#DB2777]", btnHover: "hover:bg-[#BE185D]", btnShadow: "shadow-pink-500/20", gradFrom: "from-[#DB2777]", gradTo: "to-[#1D4ED8]", stepBg: "bg-[#DB2777]", checkText: "text-[#DB2777]" },
