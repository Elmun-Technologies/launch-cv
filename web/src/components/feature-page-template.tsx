...
const ACCENT: Record<FeatureAccent, { iconBg: string; iconText: string; badge: string; badgeText: string; btnBg: string; btnHover: string; btnShadow: string; gradFrom: string; gradTo: string; stepBg: string; checkText: string }> = {
  ...
  violet: { iconBg: "bg-[#DBEAFE]", iconText: "text-[#1D4ED8]", badge: "bg-[#DBEAFE]", badgeText: "text-[#1D4ED8]", btnBg: "bg-[#2563EB]", btnHover: "hover:bg-[#1D4ED8]", btnShadow: "shadow-blue-500/25", gradFrom: "from-[#2563EB]", gradTo: "to-[#2563EB]", stepBg: "bg-[#2563EB]", checkText: "text-[#2563EB]" },
