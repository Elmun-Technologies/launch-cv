  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <button type="button" onClick={() => setShowForm((s) => !s)} className="inline-flex items-center gap-2 rounded-xl bg-[#2563EB] px-4 py-2 text-[13px] font-semibold text-white transition hover:bg-[#1D4ED8] hover:shadow-[0_4px_12px_rgba(37, 99, 235,0.25)]">
      ...
      {rows.length === 0 ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {rows.map((t) => (
            <div key={t.id} className="rounded-2xl border border-gray-100 bg-white p-5 shadow-[0_2px_8px_rgba(0,0,0,0.04)] transition hover:border-[#2563EB]/10 hover:shadow-md">
