 ...
 * Starter and Professional are monthly recurring; Lifetime is one-time. (Elite is a
 * legacy monthly plan retained only for existing subscribers, never offered publicly.)
 */
