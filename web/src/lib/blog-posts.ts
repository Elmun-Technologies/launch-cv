export type BlogPost = {
  ...
  /** Hero image path (under /public). Rendered by BlogCover via next/image. */
  coverImage?: string;
  /** Descriptive, keyword-rich alt text for the hero image. Required whenever coverImage is set. */
  coverAlt?: string;
};
